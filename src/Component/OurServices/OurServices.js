        ...
        <div className='bg-[#f5f5f5]'>
            <div className='container mx-auto p-10'>
                ...
                <div className='mt-[50px]'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-between gap-[120px] mb-[50px]'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-between gap-[120px]'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-between gap-[120px] mb-[50px] mt-[48px]'>
