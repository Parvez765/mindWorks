        ...
        <div className='serviceContainer'>
            <div className='container mx-auto p-10'>
                ...
                <div className='mt-[50px]'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-between gap-[20px] lg:gap-[50px] mb-[50px] mt-[48px]'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 justify-between  gap-[20px] lg:gap-[50px]'>
                        <div data-aos="fade-right">
