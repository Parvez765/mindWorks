...
const Training = () => {
    return (
        <div className='container mx-auto p-10'>
            <h1 className='text-center text-[35px] lg:text-[50px] text-[#002266] font-bold'>Training</h1>
            <p className='text-center lg:text-[22px] lg:w-[850px] mt-[15px] block mx-auto'>Mindworks offers training in key business functions that are integral for business growth and success. Every business problem is unique and hence, we tailor the training solutions to cater to unique business problems you may be facing. Our approach to training sessions is customized and personalized depending on your company, trainees, and the business objective of training.</p>
            <div>
                                ...
                                training?.map(tr =>
                                    <div className='mt-[20px]'>
                                        <div className='flex items-center gap-[15px]'>
                                            <img src={tr.img} className='w-[25px]' alt="Mind Works Right Mark" />
                                            <p className='text-[12px] 2xl:text-[22px] font-medium text-[#002060]'>{tr.name}</p>
                                        </div>
                                    </div>
                                )
                            }
